...
public final class LambdaFilter extends JFrame {
    ...
    private enum Command {
        ...
        LOWER("Convert to lower", s -> s.toLowerCase()),
        CCHAR("Count chars #", s -> Integer.toString(s.length())),
        CLINE("Count the number of lines", s -> Integer.toString(s.split(System.lineSeparator()).length)),
        LWORD("List all the words in alphabetical order", s -> {
